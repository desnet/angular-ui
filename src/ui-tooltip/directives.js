...
var module = angular.module('directives', ['ng']).directive('uiTooltip', ['$window', '$document', '$compile', '$parse', '$timeout', '$sce', function($window, $document, $compile, $parse, $timeout, $sce) {
